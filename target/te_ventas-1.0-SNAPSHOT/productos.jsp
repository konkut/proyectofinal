            ...
            <div class="row bg-dark">
                <div class="col-12">
                    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
                        ...
                        <a class="btn btn-primary btn-sm" href="productoControlador?action=insert"><i class="fa-solid fa-cart-plus"></i>Nuevo</a>
                        <table class="table table-striped">
                            <tr>
                                <td class="text-primary">Id</td>
                                <td class="text-primary">Nombre</td>
                                <td class="text-primary">Descripcion</td>
                            ...
                            <c:forEach var="item" items="${listaPro}">
                                <tr>
                                    ...
                                    <td class="text-white-50">${item.descripcion}</td>
                                    <td class="text-white-50">${item.precio}</td>
                                    <td><a href="productoControlador?action=update&id=${item.id}" Target="_self" ><i class="fa-solid fa-file-pen"></i></a></td>
                                    <td><a href="productoControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro???'))"><i class="fa-solid fa-trash"></i></a></td> 
                                </tr>
                            </c:forEach>
                        </table>
                    </div> 
