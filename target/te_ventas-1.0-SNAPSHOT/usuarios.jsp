            ...
            <div class="row bg-dark">
                <div class="col-12">
                    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
                        ...
                        <a class="btn btn-primary btn-sm" href="usuarioControlador?action=insert"><i class="fa-solid fa-cart-plus"></i>Nuevo</a>
                        <table class="table table-striped ">
                            ...
                            <c:forEach var="item" items="${usuarios}">
                                <tr>
                                    ...
                                    <td class="text-white-50">${item.nombres}</td>
                                    <td class="text-white-50">${item.apellidos}</td>
                                    <td class="text-white-50">${item.correo}</td>
                                    <td class="text-white-50">${item.idRol}</td>
                                    <td><a href="usuarioControlador?action=update&id=${item.id}" ><i class="fa-solid fa-file-pen"></i></a></td>
                                    <td><a href="usuarioControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro???'))"><i class="fa-solid fa-trash"></i></a></td> 
                                </tr>
                            </c:forEach>
