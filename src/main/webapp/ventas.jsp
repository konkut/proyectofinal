            ...
            <div class="row bg-dark">
                <div class="col-12">
                    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
                        ...
                        <a class="btn btn-primary btn-sm" href="ventaControlador?action=insert"><i class="fa-solid fa-cart-plus"></i>Nuevo</a>
                        <table class="table table-striped">
                            ...
                            <c:forEach var="item" items="${ventas}">
                                <tr>
                                    ...
                                    <td><a href="ventaControlador?action=update&id=${item.id}" Target="_self" ><i class="fa-solid fa-file-pen"></i></a></td>
                                    <td><a href="ventaControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro???'))"><i class="fa-solid fa-trash"></i></a></td> 
                                </tr>
                            </c:forEach>
                        </table>
                    </div> 
